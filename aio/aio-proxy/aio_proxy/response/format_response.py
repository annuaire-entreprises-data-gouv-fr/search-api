from aio_proxy.response.helpers import set_default_to_none
    ...
    for result in results:
        result_formatted = {
            ...
            "siege": {
                ...
                "date_debut_activite": set_default_to_none(
                    result, "date_debut_activite_siege"
                ),
                "etat_adiministratif": set_default_to_none(
                    result, "etat_administratif_siege"
                ),
                "activite_principale": set_default_to_none(
                    result, "activite_principale_siege"
                ),
            ...
            "nombre_etablissements": set_default_to_none(
                result, "nombre_etablissements"
            ),
            "nombre_etablissements_ouverts": set_default_to_none(
                result, "nombre_etablissements_ouverts"
            ),
            "is_entrepreneur_individuel": set_default_to_none(
                result, "is_entrepreneur_individuel"
            ),
        }
