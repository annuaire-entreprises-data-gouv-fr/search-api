    ...
    for result in results:
        result_formatted = {
            ...
            "siege": {
                ...
                "date_debut_activite": set_default(
                    result, "date_debut_activite_siege"
                ),
                "etat_adiministratif": set_default(
            ...
            "nombre_etablissements": int(set_default(
                result, "nombre_etablissements", default=1
            )),
            "nombre_etablissements_ouverts": int(set_default(
                result, "nombre_etablissements_ouverts", default=0
            )),
            "is_entrepreneur_individuel": json.loads(set_default(
                result, "is_entrepreneur_individuel", default="false").lower()),
        }
