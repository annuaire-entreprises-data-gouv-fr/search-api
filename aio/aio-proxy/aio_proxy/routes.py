...
async def search_endpoint(request):
    ...
    total_results, unite_legale, scores = search_es(Siren, terms, page*per_page, per_page)
    res = {'unite_legale': unite_legale, 'total_results': int(total_results), 'page': page + 1, 'per_page': per_page, 'scores': scores}
